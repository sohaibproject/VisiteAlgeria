                            ...
                            <div class="col-4">
                                <div class="form-group" >
                                    ...
                                    <select class="form-control" name="status" id="status">
                                        <option value="published" @if($room->status == "published")selected @endif >published</option>
                                        <option value="unpublished"  @if($room->status == "unpublished")selected @endif>unpublished</option>
                                      </select>
                                  </div>
                            </div> 
